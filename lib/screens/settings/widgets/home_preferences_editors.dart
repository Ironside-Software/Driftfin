  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...settingsListGroup(context, SettingsLabelDivider(label: context.localized.libraryOrderTitle), [
            SettingsListTile(
              label: Text(context.localized.libraryOrderDescription, style: Theme.of(context).textTheme.bodyMedium),
            ),
            ...
            SettingsListTile(
              label: Text(context.localized.groupedFoldersDescription, style: Theme.of(context).textTheme.bodyMedium),
            ),
