...
class VideoPlayerGuideWrapper extends StatefulWidget {
  final Widget child;
  const VideoPlayerGuideWrapper({required this.child, super.key});
...
class _GuideOverview extends ConsumerStatefulWidget {
  ...
  const _GuideOverview({required this.closeGuide});
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(
                        height: 125,
                        child: DriftfinImage(image: currentChanel?.images?.primary, fit: BoxFit.contain),
                      ),
                      Text(currentProgram?.name ?? "", style: Theme.of(context).textTheme.headlineMedium),
                              ...
                              child: SizedBox(
                                ...
                                child: AspectRatio(
                                  ...
                                  child: Container(
                                    ...
                                    child: DriftfinImage(image: currentProgram?.images?.primary, fit: BoxFit.fill),
                                  ),
                                ),
                              ),
                            ),
