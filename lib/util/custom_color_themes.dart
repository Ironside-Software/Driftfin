...
enum ColorThemes {
  fladder(name: 'Fladder', color: kDebugMode ? Colors.purpleAccent : kDriftfinBrandColor),
  ...
  deepBlue(name: 'Deep Blue', color: Color.fromARGB(255, 1, 34, 94)),
  ...
  const ColorThemes({required this.name, required this.color});
