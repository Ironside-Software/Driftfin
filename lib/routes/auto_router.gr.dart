...
import 'package:driftfin/models/items/photos_model.dart' as _i44;
import 'package:driftfin/models/library_search/library_search_options.dart' as _i41;
import 'package:driftfin/models/seerr/seerr_dashboard_model.dart' as _i46;
...
import 'package:driftfin/seerr/seerr_models.dart' as _i47;
...
class LibrarySearchRouteArgs {
  ...
  bool operator ==(Object other) {
    ...
    return viewModelId == other.viewModelId &&
        ...
        const _i43.MapEquality().equals(studios, other.studios) &&
        const _i43.MapEquality().equals(tags, other.tags) &&
        const _i43.MapEquality().equals(years, other.years) &&
        const _i43.MapEquality().equals(
          officialRatings,
  ...
  int get hashCode =>
      ...
      const _i43.MapEquality().hash(studios) ^
      const _i43.MapEquality().hash(tags) ^
      const _i43.MapEquality().hash(years) ^
      const _i43.MapEquality().hash(officialRatings) ^
      recursive.hashCode ^
      key.hashCode;
}
