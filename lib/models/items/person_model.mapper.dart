...
class PersonModelMapper extends SubClassMapperBase<PersonModel> {
  ...
  static const Field<PersonModel, DateTime> _f$dateOfBirth = Field(
    'dateOfBirth',
    _$dateOfBirth,
    opt: true,
  );
  static List<String> _$birthPlace(PersonModel v) => v.birthPlace;
  static const Field<PersonModel, List<String>> _f$birthPlace = Field(
    'birthPlace',
    _$birthPlace,
  );
  static Map<String, dynamic>? _$providerIds(PersonModel v) => v.providerIds;
  static const Field<PersonModel, Map<String, dynamic>> _f$providerIds = Field(
    'providerIds',
    _$providerIds,
    opt: true,
  );
  static List<MovieModel> _$movies(PersonModel v) => v.movies;
  static const Field<PersonModel, List<MovieModel>> _f$movies = Field(
    'movies',
    _$movies,
  );
  static List<SeriesModel> _$series(PersonModel v) => v.series;
  static const Field<PersonModel, List<SeriesModel>> _f$series = Field(
    'series',
    _$series,
  );
  ...
  static const Field<PersonModel, OverviewModel> _f$overview = Field(
    'overview',
    _$overview,
  );
  static String? _$parentId(PersonModel v) => v.parentId;
  static const Field<PersonModel, String> _f$parentId = Field(
    'parentId',
    _$parentId,
  );
  static String? _$playlistId(PersonModel v) => v.playlistId;
  static const Field<PersonModel, String> _f$playlistId = Field(
    'playlistId',
    _$playlistId,
  );
  static ImagesData? _$images(PersonModel v) => v.images;
  static const Field<PersonModel, ImagesData> _f$images = Field(
    'images',
    _$images,
  );
  static int? _$childCount(PersonModel v) => v.childCount;
  static const Field<PersonModel, int> _f$childCount = Field(
    'childCount',
    _$childCount,
  );
  static double? _$primaryRatio(PersonModel v) => v.primaryRatio;
  static const Field<PersonModel, double> _f$primaryRatio = Field(
    'primaryRatio',
    _$primaryRatio,
  );
  static UserData _$userData(PersonModel v) => v.userData;
  static const Field<PersonModel, UserData> _f$userData = Field(
    'userData',
    _$userData,
  );
  static bool? _$canDownload(PersonModel v) => v.canDownload;
  static const Field<PersonModel, bool> _f$canDownload = Field(
    'canDownload',
    _$canDownload,
    opt: true,
  );
  static bool? _$canDelete(PersonModel v) => v.canDelete;
  static const Field<PersonModel, bool> _f$canDelete = Field(
    'canDelete',
    _$canDelete,
    opt: true,
  );
  static BaseItemKind? _$jellyType(PersonModel v) => v.jellyType;
  static const Field<PersonModel, BaseItemKind> _f$jellyType = Field(
    'jellyType',
    _$jellyType,
    opt: true,
  );
