...
class SeriesModelMapper extends SubClassMapperBase<SeriesModel> {
  ...
  static const Field<SeriesModel, List<SeasonModel>> _f$seasons = Field(
    'seasons',
    _$seasons,
    opt: true,
  );
  static EpisodeModel? _$selectedEpisode(SeriesModel v) => v.selectedEpisode;
  static const Field<SeriesModel, EpisodeModel> _f$selectedEpisode = Field(
    'selectedEpisode',
    _$selectedEpisode,
    opt: true,
  );
  ...
  _f$specialFeatures = Field('specialFeatures', _$specialFeatures, opt: true);
  static String _$originalTitle(SeriesModel v) => v.originalTitle;
  static const Field<SeriesModel, String> _f$originalTitle = Field(
    'originalTitle',
    _$originalTitle,
  );
  static String _$sortName(SeriesModel v) => v.sortName;
  static const Field<SeriesModel, String> _f$sortName = Field(
    'sortName',
    _$sortName,
  );
  ...
  static const Field<SeriesModel, List<ItemBaseModel>> _f$related = Field(
    'related',
    _$related,
    opt: true,
    def: const [],
  ...
  static const Field<SeriesModel, Map<String, dynamic>> _f$providerIds = Field(
    'providerIds',
    _$providerIds,
    opt: true,
  );
  ...
  static const Field<SeriesModel, OverviewModel> _f$overview = Field(
    'overview',
    _$overview,
  );
  static String? _$parentId(SeriesModel v) => v.parentId;
  static const Field<SeriesModel, String> _f$parentId = Field(
    'parentId',
    _$parentId,
  );
  static String? _$playlistId(SeriesModel v) => v.playlistId;
  static const Field<SeriesModel, String> _f$playlistId = Field(
    'playlistId',
    _$playlistId,
  );
  static ImagesData? _$images(SeriesModel v) => v.images;
  static const Field<SeriesModel, ImagesData> _f$images = Field(
    'images',
    _$images,
  );
  static int? _$childCount(SeriesModel v) => v.childCount;
  static const Field<SeriesModel, int> _f$childCount = Field(
    'childCount',
    _$childCount,
  );
  static double? _$primaryRatio(SeriesModel v) => v.primaryRatio;
  static const Field<SeriesModel, double> _f$primaryRatio = Field(
    'primaryRatio',
    _$primaryRatio,
  );
  static UserData _$userData(SeriesModel v) => v.userData;
  static const Field<SeriesModel, UserData> _f$userData = Field(
    'userData',
    _$userData,
  );
  static bool? _$canDownload(SeriesModel v) => v.canDownload;
  static const Field<SeriesModel, bool> _f$canDownload = Field(
    'canDownload',
    _$canDownload,
    opt: true,
  );
  static bool? _$canDelete(SeriesModel v) => v.canDelete;
  static const Field<SeriesModel, bool> _f$canDelete = Field(
    'canDelete',
    _$canDelete,
    opt: true,
  );
  static dto.BaseItemKind? _$jellyType(SeriesModel v) => v.jellyType;
  static const Field<SeriesModel, dto.BaseItemKind> _f$jellyType = Field(
    'jellyType',
    _$jellyType,
    opt: true,
  );
...
class _SeriesModelCopyWithImpl<$R, $Out>
  ...
  get availableEpisodes => $value.availableEpisodes != null
      ? ListCopyWith(
          $value.availableEpisodes!,
          (v, t) => v.copyWith.$chain(t),
          (v) => call(availableEpisodes: v),
        )
      : null;
  @override
  ListCopyWith<
  ...
  SeriesModel $make(CopyWithData data) => SeriesModel(
    availableEpisodes: data.get(
      #availableEpisodes,
      or: $value.availableEpisodes,
    ),
