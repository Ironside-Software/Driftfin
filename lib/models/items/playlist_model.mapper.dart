...
class PlaylistModelMapper extends SubClassMapperBase<PlaylistModel> {
  ...
  static const Field<PlaylistModel, OverviewModel> _f$overview = Field(
    'overview',
    _$overview,
  );
  static String? _$parentId(PlaylistModel v) => v.parentId;
  static const Field<PlaylistModel, String> _f$parentId = Field(
    'parentId',
    _$parentId,
  );
  static String? _$playlistId(PlaylistModel v) => v.playlistId;
  static const Field<PlaylistModel, String> _f$playlistId = Field(
    'playlistId',
    _$playlistId,
  );
  static ImagesData? _$images(PlaylistModel v) => v.images;
  static const Field<PlaylistModel, ImagesData> _f$images = Field(
    'images',
    _$images,
  );
  static int? _$childCount(PlaylistModel v) => v.childCount;
  static const Field<PlaylistModel, int> _f$childCount = Field(
    'childCount',
    _$childCount,
  );
  static double? _$primaryRatio(PlaylistModel v) => v.primaryRatio;
  static const Field<PlaylistModel, double> _f$primaryRatio = Field(
    'primaryRatio',
    _$primaryRatio,
  );
  static UserData _$userData(PlaylistModel v) => v.userData;
  static const Field<PlaylistModel, UserData> _f$userData = Field(
    'userData',
    _$userData,
  );
  static bool? _$canDelete(PlaylistModel v) => v.canDelete;
  static const Field<PlaylistModel, bool> _f$canDelete = Field(
    'canDelete',
    _$canDelete,
    opt: true,
  );
  static bool? _$canDownload(PlaylistModel v) => v.canDownload;
  static const Field<PlaylistModel, bool> _f$canDownload = Field(
    'canDownload',
    _$canDownload,
    opt: true,
  );
  static BaseItemKind? _$jellyType(PlaylistModel v) => v.jellyType;
  static const Field<PlaylistModel, BaseItemKind> _f$jellyType = Field(
    'jellyType',
    _$jellyType,
    opt: true,
  );
