...
class PhotoAlbumModelMapper extends SubClassMapperBase<PhotoAlbumModel> {
  ...
  static const Field<PhotoAlbumModel, List<ItemBaseModel>> _f$photos = Field(
    'photos',
    _$photos,
  );
  ...
  static const Field<PhotoAlbumModel, OverviewModel> _f$overview = Field(
    'overview',
    _$overview,
  );
  static String? _$parentId(PhotoAlbumModel v) => v.parentId;
  static const Field<PhotoAlbumModel, String> _f$parentId = Field(
    'parentId',
    _$parentId,
  );
  static String? _$playlistId(PhotoAlbumModel v) => v.playlistId;
  static const Field<PhotoAlbumModel, String> _f$playlistId = Field(
    'playlistId',
    _$playlistId,
  );
  static ImagesData? _$images(PhotoAlbumModel v) => v.images;
  static const Field<PhotoAlbumModel, ImagesData> _f$images = Field(
    'images',
    _$images,
  );
  static int? _$childCount(PhotoAlbumModel v) => v.childCount;
  static const Field<PhotoAlbumModel, int> _f$childCount = Field(
    'childCount',
    _$childCount,
  );
  static double? _$primaryRatio(PhotoAlbumModel v) => v.primaryRatio;
  static const Field<PhotoAlbumModel, double> _f$primaryRatio = Field(
    'primaryRatio',
    _$primaryRatio,
  );
  static UserData _$userData(PhotoAlbumModel v) => v.userData;
  static const Field<PhotoAlbumModel, UserData> _f$userData = Field(
    'userData',
    _$userData,
  );
  static bool? _$canDelete(PhotoAlbumModel v) => v.canDelete;
  static const Field<PhotoAlbumModel, bool> _f$canDelete = Field(
    'canDelete',
    _$canDelete,
    opt: true,
  );
  static bool? _$canDownload(PhotoAlbumModel v) => v.canDownload;
  static const Field<PhotoAlbumModel, bool> _f$canDownload = Field(
    'canDownload',
    _$canDownload,
    opt: true,
  );
  static dto.BaseItemKind? _$jellyType(PhotoAlbumModel v) => v.jellyType;
  static const Field<PhotoAlbumModel, dto.BaseItemKind> _f$jellyType = Field(
    'jellyType',
    _$jellyType,
    opt: true,
  );
...
class PhotoModelMapper extends SubClassMapperBase<PhotoModel> {
  ...
  static const Field<PhotoModel, String> _f$albumId = Field(
    'albumId',
    _$albumId,
  );
  static DateTime? _$dateTaken(PhotoModel v) => v.dateTaken;
  static const Field<PhotoModel, DateTime> _f$dateTaken = Field(
    'dateTaken',
    _$dateTaken,
  );
  static ImagesData? _$thumbnail(PhotoModel v) => v.thumbnail;
  static const Field<PhotoModel, ImagesData> _f$thumbnail = Field(
    'thumbnail',
    _$thumbnail,
  );
  static FladderItemType _$internalType(PhotoModel v) => v.internalType;
  static const Field<PhotoModel, FladderItemType> _f$internalType = Field(
    'internalType',
    _$internalType,
  );
  ...
  static const Field<PhotoModel, OverviewModel> _f$overview = Field(
    'overview',
    _$overview,
  );
  static String? _$parentId(PhotoModel v) => v.parentId;
  static const Field<PhotoModel, String> _f$parentId = Field(
    'parentId',
    _$parentId,
  );
  static String? _$playlistId(PhotoModel v) => v.playlistId;
  static const Field<PhotoModel, String> _f$playlistId = Field(
    'playlistId',
    _$playlistId,
  );
  static ImagesData? _$images(PhotoModel v) => v.images;
  static const Field<PhotoModel, ImagesData> _f$images = Field(
    'images',
    _$images,
  );
  static int? _$childCount(PhotoModel v) => v.childCount;
  static const Field<PhotoModel, int> _f$childCount = Field(
    'childCount',
    _$childCount,
  );
  static double? _$primaryRatio(PhotoModel v) => v.primaryRatio;
  static const Field<PhotoModel, double> _f$primaryRatio = Field(
    'primaryRatio',
    _$primaryRatio,
  );
  static UserData _$userData(PhotoModel v) => v.userData;
  static const Field<PhotoModel, UserData> _f$userData = Field(
    'userData',
    _$userData,
  );
  static bool? _$canDownload(PhotoModel v) => v.canDownload;
  static const Field<PhotoModel, bool> _f$canDownload = Field(
    'canDownload',
    _$canDownload,
  );
  static bool? _$canDelete(PhotoModel v) => v.canDelete;
  static const Field<PhotoModel, bool> _f$canDelete = Field(
    'canDelete',
    _$canDelete,
  );
  static dto.BaseItemKind? _$jellyType(PhotoModel v) => v.jellyType;
  static const Field<PhotoModel, dto.BaseItemKind> _f$jellyType = Field(
    'jellyType',
    _$jellyType,
    opt: true,
  );
