...
class AlbumModelMapper extends SubClassMapperBase<AlbumModel> {
  ...
  static const Field<AlbumModel, List<String>> _f$artistIds = Field(
    'artistIds',
    _$artistIds,
    opt: true,
    def: const [],
  ...
  static const Field<AlbumModel, String> _f$albumArtist = Field(
    'albumArtist',
    _$albumArtist,
  );
  static List<String> _$albumArtistIds(AlbumModel v) => v.albumArtistIds;
  static const Field<AlbumModel, List<String>> _f$albumArtistIds = Field(
    'albumArtistIds',
    _$albumArtistIds,
    opt: true,
    def: const [],
  ...
  static const Field<AlbumModel, List<AudioModel>> _f$tracks = Field(
    'tracks',
    _$tracks,
    opt: true,
    def: const [],
  ...
  static const Field<AlbumModel, List<AlbumModel>> _f$relatedAlbums = Field(
    'relatedAlbums',
    _$relatedAlbums,
    opt: true,
    def: const [],
  ...
  static const Field<AlbumModel, List<AudioModel>> _f$relatedTracks = Field(
    'relatedTracks',
    _$relatedTracks,
    opt: true,
    def: const [],
  ...
  static const Field<AlbumModel, Map<String, dynamic>> _f$providerIds = Field(
    'providerIds',
    _$providerIds,
    opt: true,
  );
  ...
  static const Field<AlbumModel, OverviewModel> _f$overview = Field(
    'overview',
    _$overview,
  );
  static String? _$parentId(AlbumModel v) => v.parentId;
  static const Field<AlbumModel, String> _f$parentId = Field(
    'parentId',
    _$parentId,
  );
  static String? _$playlistId(AlbumModel v) => v.playlistId;
  static const Field<AlbumModel, String> _f$playlistId = Field(
    'playlistId',
    _$playlistId,
  );
  static ImagesData? _$images(AlbumModel v) => v.images;
  static const Field<AlbumModel, ImagesData> _f$images = Field(
    'images',
    _$images,
  );
  static int? _$childCount(AlbumModel v) => v.childCount;
  static const Field<AlbumModel, int> _f$childCount = Field(
    'childCount',
    _$childCount,
  );
  static double? _$primaryRatio(AlbumModel v) => v.primaryRatio;
  static const Field<AlbumModel, double> _f$primaryRatio = Field(
    'primaryRatio',
    _$primaryRatio,
  );
  static UserData _$userData(AlbumModel v) => v.userData;
  static const Field<AlbumModel, UserData> _f$userData = Field(
    'userData',
    _$userData,
  );
  static bool? _$canDelete(AlbumModel v) => v.canDelete;
  static const Field<AlbumModel, bool> _f$canDelete = Field(
    'canDelete',
    _$canDelete,
    opt: true,
  );
  static bool? _$canDownload(AlbumModel v) => v.canDownload;
  static const Field<AlbumModel, bool> _f$canDownload = Field(
    'canDownload',
    _$canDownload,
    opt: true,
  );
  static dto.BaseItemKind? _$jellyType(AlbumModel v) => v.jellyType;
  static const Field<AlbumModel, dto.BaseItemKind> _f$jellyType = Field(
    'jellyType',
    _$jellyType,
    opt: true,
  );
...
class _AlbumModelCopyWithImpl<$R, $Out>
  ...
  @override
  ListCopyWith<$R, AlbumModel, AlbumModelCopyWith<$R, AlbumModel, AlbumModel>>
  get relatedAlbums => ListCopyWith(
    $value.relatedAlbums,
    (v, t) => v.copyWith.$chain(t),
    (v) => call(relatedAlbums: v),
  );
  @override
  ListCopyWith<$R, AudioModel, AudioModelCopyWith<$R, AudioModel, AudioModel>>
  get relatedTracks => ListCopyWith(
    $value.relatedTracks,
    (v, t) => v.copyWith.$chain(t),
    (v) => call(relatedTracks: v),
  );
  @override
  MapCopyWith<$R, String, dynamic, ObjectCopyWith<$R, dynamic, dynamic>?>?
