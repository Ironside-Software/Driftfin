...
class EpisodeModelMapper extends SubClassMapperBase<EpisodeModel> {
  ...
  static const Field<EpisodeModel, String> _f$seriesName = Field(
    'seriesName',
    _$seriesName,
  );
  ...
  static const Field<EpisodeModel, int> _f$episode = Field(
    'episode',
    _$episode,
  );
  static int? _$episodeEnd(EpisodeModel v) => v.episodeEnd;
  static const Field<EpisodeModel, int> _f$episodeEnd = Field(
    'episodeEnd',
    _$episodeEnd,
  );
  static List<Chapter> _$chapters(EpisodeModel v) => v.chapters;
  static const Field<EpisodeModel, List<Chapter>> _f$chapters = Field(
    'chapters',
    _$chapters,
    opt: true,
    def: const [],
  ...
  static const Field<EpisodeModel, ItemLocation> _f$location = Field(
    'location',
    _$location,
    opt: true,
  );
  static DateTime? _$dateAired(EpisodeModel v) => v.dateAired;
  static const Field<EpisodeModel, DateTime> _f$dateAired = Field(
    'dateAired',
    _$dateAired,
    opt: true,
  );
  ...
  static const Field<EpisodeModel, OverviewModel> _f$overview = Field(
    'overview',
    _$overview,
  );
  static String? _$parentId(EpisodeModel v) => v.parentId;
  static const Field<EpisodeModel, String> _f$parentId = Field(
    'parentId',
    _$parentId,
  );
  static String? _$playlistId(EpisodeModel v) => v.playlistId;
  static const Field<EpisodeModel, String> _f$playlistId = Field(
    'playlistId',
    _$playlistId,
  );
  static ImagesData? _$images(EpisodeModel v) => v.images;
  static const Field<EpisodeModel, ImagesData> _f$images = Field(
    'images',
    _$images,
  );
  static int? _$childCount(EpisodeModel v) => v.childCount;
  static const Field<EpisodeModel, int> _f$childCount = Field(
    'childCount',
    _$childCount,
  );
  static double? _$primaryRatio(EpisodeModel v) => v.primaryRatio;
  static const Field<EpisodeModel, double> _f$primaryRatio = Field(
    'primaryRatio',
    _$primaryRatio,
  );
  static UserData _$userData(EpisodeModel v) => v.userData;
  static const Field<EpisodeModel, UserData> _f$userData = Field(
    'userData',
    _$userData,
  );
  static ImagesData? _$parentImages(EpisodeModel v) => v.parentImages;
  static const Field<EpisodeModel, ImagesData> _f$parentImages = Field(
    'parentImages',
    _$parentImages,
  );
  static MediaStreamsModel _$mediaStreams(EpisodeModel v) => v.mediaStreams;
  static const Field<EpisodeModel, MediaStreamsModel> _f$mediaStreams = Field(
    'mediaStreams',
    _$mediaStreams,
  );
  static bool? _$canDelete(EpisodeModel v) => v.canDelete;
  static const Field<EpisodeModel, bool> _f$canDelete = Field(
    'canDelete',
    _$canDelete,
    opt: true,
  );
  static bool? _$canDownload(EpisodeModel v) => v.canDownload;
  static const Field<EpisodeModel, bool> _f$canDownload = Field(
    'canDownload',
    _$canDownload,
    opt: true,
  );
  static dto.BaseItemKind? _$jellyType(EpisodeModel v) => v.jellyType;
  static const Field<EpisodeModel, dto.BaseItemKind> _f$jellyType = Field(
    'jellyType',
    _$jellyType,
    opt: true,
  );
