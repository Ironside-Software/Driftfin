...
class MovieModelMapper extends SubClassMapperBase<MovieModel> {
  ...
  static const Field<MovieModel, String> _f$originalTitle = Field(
    'originalTitle',
    _$originalTitle,
  );
  static String? _$path(MovieModel v) => v.path;
  static const Field<MovieModel, String> _f$path = Field(
    'path',
    _$path,
    opt: true,
  );
  static List<Chapter> _$chapters(MovieModel v) => v.chapters;
  static const Field<MovieModel, List<Chapter>> _f$chapters = Field(
    'chapters',
    _$chapters,
    opt: true,
    def: const [],
  ...
  static const Field<MovieModel, DateTime> _f$premiereDate = Field(
    'premiereDate',
    _$premiereDate,
  );
  static String _$sortName(MovieModel v) => v.sortName;
  static const Field<MovieModel, String> _f$sortName = Field(
    'sortName',
    _$sortName,
  );
  ...
  static const Field<MovieModel, List<ItemBaseModel>> _f$related = Field(
    'related',
    _$related,
    opt: true,
    def: const [],
  ...
  static const Field<MovieModel, Map<String, dynamic>> _f$providerIds = Field(
    'providerIds',
    _$providerIds,
    opt: true,
  );
  ...
  static const Field<MovieModel, OverviewModel> _f$overview = Field(
    'overview',
    _$overview,
  );
  static String? _$parentId(MovieModel v) => v.parentId;
  static const Field<MovieModel, String> _f$parentId = Field(
    'parentId',
    _$parentId,
  );
  static String? _$playlistId(MovieModel v) => v.playlistId;
  static const Field<MovieModel, String> _f$playlistId = Field(
    'playlistId',
    _$playlistId,
  );
  static ImagesData? _$images(MovieModel v) => v.images;
  static const Field<MovieModel, ImagesData> _f$images = Field(
    'images',
    _$images,
  );
  static int? _$childCount(MovieModel v) => v.childCount;
  static const Field<MovieModel, int> _f$childCount = Field(
    'childCount',
    _$childCount,
  );
  static double? _$primaryRatio(MovieModel v) => v.primaryRatio;
  static const Field<MovieModel, double> _f$primaryRatio = Field(
    'primaryRatio',
    _$primaryRatio,
  );
  static UserData _$userData(MovieModel v) => v.userData;
  static const Field<MovieModel, UserData> _f$userData = Field(
    'userData',
    _$userData,
  );
  static ImagesData? _$parentImages(MovieModel v) => v.parentImages;
  static const Field<MovieModel, ImagesData> _f$parentImages = Field(
    'parentImages',
    _$parentImages,
  );
  static MediaStreamsModel _$mediaStreams(MovieModel v) => v.mediaStreams;
  static const Field<MovieModel, MediaStreamsModel> _f$mediaStreams = Field(
    'mediaStreams',
    _$mediaStreams,
  );
  static bool? _$canDownload(MovieModel v) => v.canDownload;
  static const Field<MovieModel, bool> _f$canDownload = Field(
    'canDownload',
    _$canDownload,
  );
  static bool? _$canDelete(MovieModel v) => v.canDelete;
  static const Field<MovieModel, bool> _f$canDelete = Field(
    'canDelete',
    _$canDelete,
  );
  static dto.BaseItemKind? _$jellyType(MovieModel v) => v.jellyType;
  static const Field<MovieModel, dto.BaseItemKind> _f$jellyType = Field(
    'jellyType',
    _$jellyType,
    opt: true,
  );
...
abstract class MovieModelCopyWith<$R, $In extends MovieModel, $Out>
  ...
  ListCopyWith<
    $R,
    SpecialFeatureModel,
    SpecialFeatureModelCopyWith<$R, SpecialFeatureModel, SpecialFeatureModel>
  >
  get specialFeatures;
  ListCopyWith<
    $R,
  ...
  ListCopyWith<
    ...
    ObjectCopyWith<$R, SeerrDashboardPosterModel, SeerrDashboardPosterModel>
  >
  get seerrRelated;
  ListCopyWith<
    $R,
...
class _MovieModelCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<
    ...
    SpecialFeatureModelCopyWith<$R, SpecialFeatureModel, SpecialFeatureModel>
  >
  get specialFeatures => ListCopyWith(
