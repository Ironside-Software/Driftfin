...
class AudioModelMapper extends SubClassMapperBase<AudioModel> {
  ...
  static const Field<AudioModel, String> _f$album = Field(
    'album',
    _$album,
    opt: true,
  );
  static String? _$albumId(AudioModel v) => v.albumId;
  static const Field<AudioModel, String> _f$albumId = Field(
    'albumId',
    _$albumId,
    opt: true,
  );
  static List<MusicArtistModel> _$artists(AudioModel v) => v.artists;
  static const Field<AudioModel, List<MusicArtistModel>> _f$artists = Field(
    'artists',
    _$artists,
    opt: true,
    def: const [],
  ...
  static const Field<AudioModel, int> _f$trackNumber = Field(
    'trackNumber',
    _$trackNumber,
    opt: true,
  );
  static int? _$discNumber(AudioModel v) => v.discNumber;
  static const Field<AudioModel, int> _f$discNumber = Field(
    'discNumber',
    _$discNumber,
    opt: true,
  );
  static Map<String, dynamic>? _$providerIds(AudioModel v) => v.providerIds;
  static const Field<AudioModel, Map<String, dynamic>> _f$providerIds = Field(
    'providerIds',
    _$providerIds,
    opt: true,
  );
  static double? _$normalizationGain(AudioModel v) => v.normalizationGain;
  static const Field<AudioModel, double> _f$normalizationGain = Field(
    'normalizationGain',
    _$normalizationGain,
    opt: true,
  );
  ...
  static const Field<AudioModel, OverviewModel> _f$overview = Field(
    'overview',
    _$overview,
  );
  static String? _$parentId(AudioModel v) => v.parentId;
  static const Field<AudioModel, String> _f$parentId = Field(
    'parentId',
    _$parentId,
  );
  static String? _$playlistId(AudioModel v) => v.playlistId;
  static const Field<AudioModel, String> _f$playlistId = Field(
    'playlistId',
    _$playlistId,
  );
  static ImagesData? _$images(AudioModel v) => v.images;
  static const Field<AudioModel, ImagesData> _f$images = Field(
    'images',
    _$images,
  );
  static int? _$childCount(AudioModel v) => v.childCount;
  static const Field<AudioModel, int> _f$childCount = Field(
    'childCount',
    _$childCount,
  );
  static double? _$primaryRatio(AudioModel v) => v.primaryRatio;
  static const Field<AudioModel, double> _f$primaryRatio = Field(
    'primaryRatio',
    _$primaryRatio,
  );
  static UserData _$userData(AudioModel v) => v.userData;
  static const Field<AudioModel, UserData> _f$userData = Field(
    'userData',
    _$userData,
  );
  static ImagesData? _$parentImages(AudioModel v) => v.parentImages;
  static const Field<AudioModel, ImagesData> _f$parentImages = Field(
    'parentImages',
    _$parentImages,
  );
  static MediaStreamsModel _$mediaStreams(AudioModel v) => v.mediaStreams;
  static const Field<AudioModel, MediaStreamsModel> _f$mediaStreams = Field(
    'mediaStreams',
    _$mediaStreams,
  );
  static bool? _$canDelete(AudioModel v) => v.canDelete;
  static const Field<AudioModel, bool> _f$canDelete = Field(
    'canDelete',
    _$canDelete,
    opt: true,
  );
  static bool? _$canDownload(AudioModel v) => v.canDownload;
  static const Field<AudioModel, bool> _f$canDownload = Field(
    'canDownload',
    _$canDownload,
    opt: true,
  );
  static dto.BaseItemKind? _$jellyType(AudioModel v) => v.jellyType;
  static const Field<AudioModel, dto.BaseItemKind> _f$jellyType = Field(
    'jellyType',
    _$jellyType,
    opt: true,
  );
...
class _AudioModelCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<
    ...
    MusicArtistModelCopyWith<$R, MusicArtistModel, MusicArtistModel>
  >
  get albumArtists => ListCopyWith(
    $value.albumArtists,
    (v, t) => v.copyWith.$chain(t),
    (v) => call(albumArtists: v),
  );
  @override
  MapCopyWith<$R, String, dynamic, ObjectCopyWith<$R, dynamic, dynamic>?>?
  ...
  AudioModel $make(CopyWithData data) => AudioModel(
    ...
    normalizationGain: data.get(
      #normalizationGain,
      or: $value.normalizationGain,
    ),
    name: data.get(#name, or: $value.name),
    id: data.get(#id, or: $value.id),
