...
class ArtistModelMapper extends SubClassMapperBase<ArtistModel> {
  ...
  static const Field<ArtistModel, List<AlbumModel>> _f$albums = Field(
    'albums',
    _$albums,
    opt: true,
    def: const [],
  ...
  static const Field<ArtistModel, List<AudioModel>> _f$tracks = Field(
    'tracks',
    _$tracks,
    opt: true,
    def: const [],
  ...
  static const Field<ArtistModel, List<AudioModel>> _f$favoriteTracks = Field(
    'favoriteTracks',
    _$favoriteTracks,
    opt: true,
    def: const [],
  ...
  static const Field<ArtistModel, List<ArtistModel>> _f$similarArtists = Field(
    'similarArtists',
    _$similarArtists,
    opt: true,
    def: const [],
  ...
  static const Field<ArtistModel, Map<String, dynamic>> _f$providerIds = Field(
    'providerIds',
    _$providerIds,
    opt: true,
  );
  ...
  static const Field<ArtistModel, OverviewModel> _f$overview = Field(
    'overview',
    _$overview,
  );
  static String? _$parentId(ArtistModel v) => v.parentId;
  static const Field<ArtistModel, String> _f$parentId = Field(
    'parentId',
    _$parentId,
  );
  static String? _$playlistId(ArtistModel v) => v.playlistId;
  static const Field<ArtistModel, String> _f$playlistId = Field(
    'playlistId',
    _$playlistId,
  );
  static ImagesData? _$images(ArtistModel v) => v.images;
  static const Field<ArtistModel, ImagesData> _f$images = Field(
    'images',
    _$images,
  );
  static int? _$childCount(ArtistModel v) => v.childCount;
  static const Field<ArtistModel, int> _f$childCount = Field(
    'childCount',
    _$childCount,
  );
  static double? _$primaryRatio(ArtistModel v) => v.primaryRatio;
  static const Field<ArtistModel, double> _f$primaryRatio = Field(
    'primaryRatio',
    _$primaryRatio,
  );
  static UserData _$userData(ArtistModel v) => v.userData;
  static const Field<ArtistModel, UserData> _f$userData = Field(
    'userData',
    _$userData,
  );
  static bool? _$canDelete(ArtistModel v) => v.canDelete;
  static const Field<ArtistModel, bool> _f$canDelete = Field(
    'canDelete',
    _$canDelete,
    opt: true,
  );
  static bool? _$canDownload(ArtistModel v) => v.canDownload;
  static const Field<ArtistModel, bool> _f$canDownload = Field(
    'canDownload',
    _$canDownload,
    opt: true,
  );
  static dto.BaseItemKind? _$jellyType(ArtistModel v) => v.jellyType;
  static const Field<ArtistModel, dto.BaseItemKind> _f$jellyType = Field(
    'jellyType',
    _$jellyType,
    opt: true,
  );
...
class _ArtistModelCopyWithImpl<$R, $Out>
  ...
  @override
  ListCopyWith<$R, AudioModel, AudioModelCopyWith<$R, AudioModel, AudioModel>>
  get favoriteTracks => ListCopyWith(
    $value.favoriteTracks,
    (v, t) => v.copyWith.$chain(t),
    (v) => call(favoriteTracks: v),
  );
  @override
  ListCopyWith<
    $R,
    ...
    ArtistModelCopyWith<$R, ArtistModel, ArtistModel>
  >
  get similarArtists => ListCopyWith(
    $value.similarArtists,
    (v, t) => v.copyWith.$chain(t),
    (v) => call(similarArtists: v),
  );
  @override
  MapCopyWith<$R, String, dynamic, ObjectCopyWith<$R, dynamic, dynamic>?>?
