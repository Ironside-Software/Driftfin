...
class OverviewModelMapper extends ClassMapperBase<OverviewModel> {
  ...
  static const Field<OverviewModel, Duration> _f$runTime = Field(
    'runTime',
    _$runTime,
    opt: true,
  );
  static String _$summary(OverviewModel v) => v.summary;
  static const Field<OverviewModel, String> _f$summary = Field(
    'summary',
    _$summary,
    opt: true,
    def: "",
  ...
  static const Field<OverviewModel, int> _f$yearAired = Field(
    'yearAired',
    _$yearAired,
    opt: true,
  );
  static DateTime? _$dateAdded(OverviewModel v) => v.dateAdded;
  static const Field<OverviewModel, DateTime> _f$dateAdded = Field(
    'dateAdded',
    _$dateAdded,
    opt: true,
  );
  static String? _$parentalRating(OverviewModel v) => v.parentalRating;
  static const Field<OverviewModel, String> _f$parentalRating = Field(
    'parentalRating',
    _$parentalRating,
    opt: true,
  );
  static int? _$productionYear(OverviewModel v) => v.productionYear;
  static const Field<OverviewModel, int> _f$productionYear = Field(
    'productionYear',
    _$productionYear,
    opt: true,
  );
  static double? _$criticRating(OverviewModel v) => v.criticRating;
  static const Field<OverviewModel, double> _f$criticRating = Field(
    'criticRating',
    _$criticRating,
    opt: true,
  );
  static double? _$communityRating(OverviewModel v) => v.communityRating;
  static const Field<OverviewModel, double> _f$communityRating = Field(
    'communityRating',
    _$communityRating,
    opt: true,
  );
  ...
  static const Field<OverviewModel, List<Chapter>> _f$chapters = Field(
    'chapters',
    _$chapters,
    opt: true,
  );
  static List<ExternalUrls>? _$externalUrls(OverviewModel v) => v.externalUrls;
  static const Field<OverviewModel, List<ExternalUrls>> _f$externalUrls = Field(
    'externalUrls',
    _$externalUrls,
    opt: true,
  );
  static List<Studio> _$studios(OverviewModel v) => v.studios;
  static const Field<OverviewModel, List<Studio>> _f$studios = Field(
    'studios',
    _$studios,
    opt: true,
    def: const [],
  ...
  static const Field<OverviewModel, List<String>> _f$genres = Field(
    'genres',
    _$genres,
    opt: true,
    def: const [],
  ...
  static const Field<OverviewModel, List<GenreItems>> _f$genreItems = Field(
    'genreItems',
    _$genreItems,
    opt: true,
    def: const [],
  ...
  static const Field<OverviewModel, List<String>> _f$tags = Field(
    'tags',
    _$tags,
    opt: true,
    def: const [],
  ...
  static const Field<OverviewModel, List<Person>> _f$people = Field(
    'people',
    _$people,
    opt: true,
    def: const [],
  ...
  static const Field<OverviewModel, String> _f$seerrUrl = Field(
    'seerrUrl',
    _$seerrUrl,
    opt: true,
  );
