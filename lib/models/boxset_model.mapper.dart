...
class BoxSetModelMapper extends SubClassMapperBase<BoxSetModel> {
  ...
  static const Field<BoxSetModel, List<ItemBaseModel>> _f$items = Field(
    'items',
    _$items,
    opt: true,
    def: const [],
  ...
  static const Field<BoxSetModel, OverviewModel> _f$overview = Field(
    'overview',
    _$overview,
  );
  static String? _$parentId(BoxSetModel v) => v.parentId;
  static const Field<BoxSetModel, String> _f$parentId = Field(
    'parentId',
    _$parentId,
  );
  static String? _$playlistId(BoxSetModel v) => v.playlistId;
  static const Field<BoxSetModel, String> _f$playlistId = Field(
    'playlistId',
    _$playlistId,
  );
  static ImagesData? _$images(BoxSetModel v) => v.images;
  static const Field<BoxSetModel, ImagesData> _f$images = Field(
    'images',
    _$images,
  );
  static int? _$childCount(BoxSetModel v) => v.childCount;
  static const Field<BoxSetModel, int> _f$childCount = Field(
    'childCount',
    _$childCount,
  );
  static double? _$primaryRatio(BoxSetModel v) => v.primaryRatio;
  static const Field<BoxSetModel, double> _f$primaryRatio = Field(
    'primaryRatio',
    _$primaryRatio,
  );
  static UserData _$userData(BoxSetModel v) => v.userData;
  static const Field<BoxSetModel, UserData> _f$userData = Field(
    'userData',
    _$userData,
  );
  static bool? _$canDelete(BoxSetModel v) => v.canDelete;
  static const Field<BoxSetModel, bool> _f$canDelete = Field(
    'canDelete',
    _$canDelete,
  );
  static bool? _$canDownload(BoxSetModel v) => v.canDownload;
  static const Field<BoxSetModel, bool> _f$canDownload = Field(
    'canDownload',
    _$canDownload,
  );
  static BaseItemKind? _$jellyType(BoxSetModel v) => v.jellyType;
  static const Field<BoxSetModel, BaseItemKind> _f$jellyType = Field(
    'jellyType',
    _$jellyType,
    opt: true,
  );
