...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  final _this = this as AccountModel;
  return 'AccountModel(name: ${_this.name}, id: ${_this.id}, avatar: ${_this.avatar}, lastUsed: ${_this.lastUsed}, authMethod: ${_this.authMethod}, askForAuthOnLaunch: ${_this.askForAuthOnLaunch}, localPin: ${_this.localPin}, credentials: ${_this.credentials}, seerrCredentials: ${_this.seerrCredentials}, managedIntegrations: ${_this.managedIntegrations}, manualIntegrations: ${_this.manualIntegrations}, latestItemsExcludes: ${_this.latestItemsExcludes}, searchQueryHistory: ${_this.searchQueryHistory}, quickConnectState: ${_this.quickConnectState}, libraryFilters: ${_this.libraryFilters}, updateNotificationsEnabled: ${_this.updateNotificationsEnabled}, seerrRequestsEnabled: ${_this.seerrRequestsEnabled}, includeHiddenViews: ${_this.includeHiddenViews}, incognitoMode: ${_this.incognitoMode}, policy: ${_this.policy}, serverConfiguration: ${_this.serverConfiguration}, userConfiguration: ${_this.userConfiguration}, hasPassword: ${_this.hasPassword}, hasConfiguredPassword: ${_this.hasConfiguredPassword}, userSettings: ${_this.userSettings})';
}
...
as bool,manualIntegrations: null == manualIntegrations ? _self.manualIntegrations : manualIntegrations // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey() final  bool manualIntegrations;
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
    return 'AccountModel(name: $name, id: $id, avatar: $avatar, lastUsed: $lastUsed, authMethod: $authMethod, askForAuthOnLaunch: $askForAuthOnLaunch, localPin: $localPin, credentials: $credentials, seerrCredentials: $seerrCredentials, managedIntegrations: $managedIntegrations, manualIntegrations: $manualIntegrations, latestItemsExcludes: $latestItemsExcludes, searchQueryHistory: $searchQueryHistory, quickConnectState: $quickConnectState, libraryFilters: $libraryFilters, updateNotificationsEnabled: $updateNotificationsEnabled, seerrRequestsEnabled: $seerrRequestsEnabled, includeHiddenViews: $includeHiddenViews, incognitoMode: $incognitoMode, policy: $policy, serverConfiguration: $serverConfiguration, userConfiguration: $userConfiguration, hasPassword: $hasPassword, hasConfiguredPassword: $hasConfiguredPassword, userSettings: $userSettings)';
}
