...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  final _this = this as AccountModel;
  return 'AccountModel(name: ${_this.name}, id: ${_this.id}, avatar: ${_this.avatar}, lastUsed: ${_this.lastUsed}, authMethod: ${_this.authMethod}, askForAuthOnLaunch: ${_this.askForAuthOnLaunch}, localPin: ${_this.localPin}, credentials: ${_this.credentials}, seerrCredentials: ${_this.seerrCredentials}, latestItemsExcludes: ${_this.latestItemsExcludes}, searchQueryHistory: ${_this.searchQueryHistory}, quickConnectState: ${_this.quickConnectState}, libraryFilters: ${_this.libraryFilters}, updateNotificationsEnabled: ${_this.updateNotificationsEnabled}, seerrRequestsEnabled: ${_this.seerrRequestsEnabled}, includeHiddenViews: ${_this.includeHiddenViews}, incognitoMode: ${_this.incognitoMode}, policy: ${_this.policy}, serverConfiguration: ${_this.serverConfiguration}, userConfiguration: ${_this.userConfiguration}, hasPassword: ${_this.hasPassword}, hasConfiguredPassword: ${_this.hasConfiguredPassword}, userSettings: ${_this.userSettings})';
}
...
as SeerrCredentialsModel?,latestItemsExcludes: null == latestItemsExcludes ? _self.latestItemsExcludes : latestItemsExcludes // ignore: cast_nullable_to_non_nullable
...
as String,credentials: null == credentials ? _self.credentials : credentials // ignore: cast_nullable_to_non_nullable
as CredentialsModel,seerrCredentials: freezed == seerrCredentials ? _self.seerrCredentials : seerrCredentials // ignore: cast_nullable_to_non_nullable
as SeerrCredentialsModel?,latestItemsExcludes: null == latestItemsExcludes ? _self._latestItemsExcludes : latestItemsExcludes // ignore: cast_nullable_to_non_nullable
