...
_HomeSettingsModel _$HomeSettingsModelFromJson(Map<String, dynamic> json) => _HomeSettingsModel(
  ...
  layoutStates:
      (json['layoutStates'] as List<dynamic>?)?.map((e) => $enumDecode(_$ViewSizeEnumMap, e)).toSet() ??
  ...
  nextUp:
      $enumDecodeNullable(_$HomeNextUpEnumMap, json['nextUp'], unknownValue: HomeNextUp.separate) ??
      HomeNextUp.separate,
  pinnedCollectionIds:
      (json['pinnedCollectionIds'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const <String>[],
);
...
const _$LayoutModeEnumMap = {LayoutMode.single: 'single', LayoutMode.dual: 'dual'};
