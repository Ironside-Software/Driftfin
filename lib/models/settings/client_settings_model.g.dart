...
_ClientSettingsModel _$ClientSettingsModelFromJson(Map<String, dynamic> json) => _ClientSettingsModel(
  ...
  smartDownloadBudgetBytes: (json['smartDownloadBudgetBytes'] as num?)?.toInt(),
  schemeVariant:
  ...
  shortcuts:
      (json['shortcuts'] as Map<String, dynamic>?)?.map(
        (k, e) => MapEntry($enumDecode(_$GlobalHotKeysEnumMap, k), KeyCombination.fromJson(e as Map<String, dynamic>)),
      ) ??
      const {},
);
...
Map<String, dynamic> _$ClientSettingsModelToJson(_ClientSettingsModel instance) => <String, dynamic>{
  ...
  'smartDownloadBudgetBytes': instance.smartDownloadBudgetBytes,
